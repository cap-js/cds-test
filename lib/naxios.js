...
class Naxios {
  ...
  /**
   * @param {string} url
   * @param {string | object | Readable} data
   * @param {Parameters<Naxios['options4']>[number]} [config]
   */
   ...
   * @param {ConstructorParameters<typeof URLSearchParams>[number]} parameters.params
  ...
  options4 ({ url, params, data, headers, ...rest }) {
    const o = { ...this.defaults, ...rest, headers: new Headers (this.defaults.headers), url }
