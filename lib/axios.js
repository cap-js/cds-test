...
class Axios {
  ...
  get     (/** @type{any} */..._) { return this.axios.get     (..._args(_)) .catch(_error) }
  put     (/** @type{any} */..._) { return this.axios.put     (..._args(_)) .catch(_error) }
  post    (/** @type{any} */..._) { return this.axios.post    (..._args(_)) .catch(_error) }
  patch   (/** @type{any} */..._) { return this.axios.patch   (..._args(_)) .catch(_error) }
  delete  (/** @type{any} */..._) { return this.axios.delete  (..._args(_)) .catch(_error) }
  options (/** @type{any} */..._) { return this.axios.options (..._args(_)) .catch(_error) }
